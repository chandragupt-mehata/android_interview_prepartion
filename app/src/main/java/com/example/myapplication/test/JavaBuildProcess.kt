...
// JVM vs DVM
// dvm is registered based machine while
// JVM is stack based
// Initially DVM used to use JIT to convert dex code into machine code
// but now DVM replaced by ART which uses AOT compiler to do the same job here
